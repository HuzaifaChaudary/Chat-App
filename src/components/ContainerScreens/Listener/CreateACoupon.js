...
export default function CreateACoupon(){
...
return(
    ...
    >
      ...
      <TouchableOpacity onPress={()=>{open(false)}} style={{width:"auto" ,display:"flex",justifyContent:"center",alignItems:"center" , height:30, backgroundColor:"rgba(103, 79, 119, 1)",borderRadius:10,borderWidth:1,borderColor:'white',paddingLeft:20,paddingRight:20}}><Text style={{color:"white"}}>close</Text></TouchableOpacity>
      </View>
    </LinearGradient>
