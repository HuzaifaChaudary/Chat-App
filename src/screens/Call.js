...
import PhoneIcon from '../../assets/phone-f.png';
import EllipseBackground from '../../assets/Ellipse1189.png';
            ...
            <View style={styles.rightSwipeContainer}>
                ...
                <View style={styles.swipeIconsContainer}>
                    <View style={styles.swipeIconContainer}>
                        ...
                        <Text style={styles.swipeText}>Calls</Text>
                        ...
                        <View style={styles.textContainer}>
                            ...
                            <TouchableOpacity style={styles.additionalUnreadButton} onPress={() => {/* Add functionality for the button */ }}>
                                <ImageBackground
                                    ...
                                    source={EllipseBackground}
                                >
                                    <Image source={PhoneIcon} style={styles.additionalUnreadImage} />
                                </ImageBackground>
                            </TouchableOpacity>
